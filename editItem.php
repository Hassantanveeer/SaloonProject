...
<div class="container">
    ...
    <input type="hidden" name="hiddenId" value="<?php echo $_GET['itemId']; ?>">
    
    <input type="text" name="itemName" class="form-control" id="exampleFormControlFile1">
  </div>
        <div class="form-group">
    <label for="exampleFormControlFile1">item Price</label>
    
    <input type="text" name="price" class="form-control" id="exampleFormControlFile1">
  </div>

  <button type="submit" class="btn btn-danger" name="edit_item">Add</button>
</div>
  <br>
</form> 
